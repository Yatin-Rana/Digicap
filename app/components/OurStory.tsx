      ...
      <section className="bg-gray-100 py-20 ">
        <div className="w-[80%] mx-auto bg-white rounded-lg shadow-xl overflow-hidden transform -translate-y-6">
          <div className="px-8 py-8">
            <h2 className="text-5xl font-bold text-center text-gray-900 mb-4">Meet Digicap</h2>
            <h3 className="text-xl font-medium text-center text-gray-600 mb-12">Where Innovation Meets Impact</h3>
            ...
            <div className="mt-12 flex justify-center">
              <a href="/contact" className="bg-black text-white px-10 py-4 rounded-md text-lg font-semibold hover:bg-gray-800 transition duration-300">
                Get in Touch
              </a>
            </div>
          </div>
